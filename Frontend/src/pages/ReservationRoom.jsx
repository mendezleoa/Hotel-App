      ...
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-300 mb-5">
          ...
          <div className="flex ml-6 items-center">
            ...
            <h2 className="text-gray-900 text-2xl title-font font-medium mb-1">{item.capacidad}</h2>
          </div>
        </div>
        <div className="flex">
          <span className="title-font font-medium text-2xl text-gray-900">${item.tarifa}</span>
          <button className="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">Reservar</button>
