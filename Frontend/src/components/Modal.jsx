  ...
  return (
    <>
      <div className="px-2 sm:px-6 py-3">
        <button
          className="bg-blue-500 text-gray-100 hover:bg-blue-600 active:bg-blue-600 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none ml-4 mb-1 ease-linear transition-all duration-150"
          type="button"
          onClick={() => {
            setShowModal(true);
          }}
